        ...
        <div className="navbar-box flex items-center justify-between">
          ...
          <ul
            className={`flex lg:gap-12 md:static md:flex-row md:shadow-none md:bg-transparent md:w-auto md:h-full
             md:translate-y-0 md:text-black md:p-0 md:m-0 md:transition-none gap-8 fixed ${menuActive} top-1/2 -translate-y-1/2 flex-col px-8 p-6
          ...
          >
            ...
            <li className="flex items-center gap-3">
              <i className="ri-info-i text-3xl md:hidden block"></i>
              <a href="#about" className="font-medium opacity-75">
                Tentang
              </a>
            </li>
            <li className="flex items-center gap-3">
              <i className="ri-tools-line text-3xl md:hidden block"></i>
          ...
          <div className="social flex items-center gap-2">
            <a
              href="#social"
              className="bg-sky-400 px-5 py-2 rounded-full text-white font-bold hover:bg-sky-500"
            >
              Soscial Media
            </a>
            <i
